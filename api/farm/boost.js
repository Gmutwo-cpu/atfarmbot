...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // Mengurangi waktu panen langsung selesai (set ke waktu sekarang)
    ...
    return res.status(200).json({ success: true, message: 'Crop boosted successfully!', user: updatedUser, plots });
  } catch (err) {
